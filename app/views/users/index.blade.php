				...
				<tbody>
					@foreach($users as $user)
						<tr>
							...
							<td>{{ $user->twitter }}</td>
							<td>
								<a href="/Php/laravel_1/public/users/show/{{ $user->id }}"><span class="label label-info">Ver</span></a>
								<a href="/Php/laravel_1/public/users/edit/{{ $user->id }}"><span class="label label-success">Editar</span></a>
